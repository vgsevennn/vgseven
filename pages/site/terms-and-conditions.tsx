  ...
  return (
    <div>
      ...
      <div className={styles.main}>
        ...
        <article>
          <span>Last updated : Sep 16, 2022</span>
          <p>
          ...
          <p>
            For the purposes of these Terms and Conditions : - Affiliate means
          ...
          <ul>
            ...
            <li>Website refers to VG, accessible from internet</li>
            <li>
          ...
          <p>
            ...
            you are over the age of 12. The Company does not permit those under
            12 to use the Service. Your access to and use of the Service is also
          ...
          <p>
            ...
            contact us By email : <b> mailteamseven@gmail.com </b>
          </p>
        </article>
        <Social />
      </div>
