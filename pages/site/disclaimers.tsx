  ...
  return (
    <div>
      ...
      <div className={styles.main}>
        <h1> Disclaimer </h1>
        <article>
          <span> Last updated: Oct 7, 2022 </span>
          ...
          <ul>
            ...
            <li>Website refers to V G, accessible from internet.</li>
          </ul>
          ...
          <h3>Use Disclaimer</h3>
          <p>
            The Company doesn&apos;t use any copyrighted material which has not
          ...
          <p>
            ...
            By email : <b> mailteamseven@gmail.com </b>
          </p>
        </article>
        <Social />
      </div>
